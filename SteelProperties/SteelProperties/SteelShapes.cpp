...
void SteelShapes::pass_str_from_user(std::string& passed_str) {
    // set member variable to the value provided by the user
    this->input_name = passed_str;

    read_data_from_files();
}


void SteelShapes::read_data_from_files() {
...
std::string SteelShapes::GetShapeProperties() {

    if (hasError()) {
        std::cout << "Error detected, cannot print shape properties\n";
        return "Error detected, cannot print shape properties\n";
    }
    ...
    // Prints the non zero properties of the shape input
    output << std::left << std::setw(61) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Type << " " << itt->uom << "\r\n"; itt++;
    output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << EDI_Name << " " << itt->uom << "\r\n"; itt++;
    output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << t_f << " " << itt->uom << "\r\n"; itt++;
    if (W > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << W << " " << itt->uom << "\r\n"; itt++;
    if (A > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << A << " " << itt->uom << "\r\n"; itt++;
    if (d > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << d << " " << itt->uom << "\r\n"; itt++;
    if (ddet > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << ddet << " " << itt->uom << "\r\n"; itt++;
    if (Ht > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Ht << " " << itt->uom << "\r\n"; itt++;
    if (h > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << h << " " << itt->uom << "\r\n"; itt++;
    if (OD > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << OD << " " << itt->uom << "\r\n"; itt++;
    if (bf > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << bf << " " << itt->uom << "\r\n"; itt++;
    if (bfdet > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << bfdet << " " << itt->uom << "\r\n"; itt++;
    if (B1 > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << B1 << " " << itt->uom << "\r\n"; itt++;
    if (b > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << b << " " << itt->uom << "\r\n"; itt++;
    if (ID > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << ID << " " << itt->uom << "\r\n"; itt++;
    if (tw > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << tw << " " << itt->uom << "\r\n"; itt++;
    if (twdet > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << twdet << " " << itt->uom << "\r\n"; itt++;
    if (twdet_2 > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << twdet_2 << " " << itt->uom << "\r\n"; itt++;
    if (tf > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << tf << " " << itt->uom << "\r\n"; itt++;
    if (tfdet > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << tfdet << " " << itt->uom << "\r\n"; itt++;
    if (t > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << t << " " << itt->uom << "\r\n"; itt++;
    if (tnom > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << tnom << " " << itt->uom << "\r\n"; itt++;
    if (tdes > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << tdes << " " << itt->uom << "\r\n"; itt++;
    if (kdes > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << kdes << " " << itt->uom << "\r\n"; itt++;
    if (kdet > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << kdet << " " << itt->uom << "\r\n"; itt++;
    if (k1 > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << k1 << " " << itt->uom << "\r\n"; itt++;
    if (x > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << x << " " << itt->uom << "\r\n"; itt++;
    if (y > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << y << " " << itt->uom << "\r\n"; itt++;
    if (eo > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << eo << " " << itt->uom << "\r\n"; itt++;
    if (xp > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << xp << " " << itt->uom << "\r\n"; itt++;
    if (yp > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << yp << " " << itt->uom << "\r\n"; itt++;
    if (bf_2tf > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << bf_2tf << " " << itt->uom << "\r\n"; itt++;
    if (b_t > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << b_t << " " << itt->uom << "\r\n"; itt++;
    if (b_tdes > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << b_tdes << " " << itt->uom << "\r\n"; itt++;
    if (h_tw > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << h_tw << " " << itt->uom << "\r\n"; itt++;
    if (h_tdes > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << h_tdes << " " << itt->uom << "\r\n"; itt++;
    if (D_t > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << D_t << " " << itt->uom << "\r\n"; itt++;
    if (Ix > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Ix << " " << itt->uom << "\r\n"; itt++;
    if (Zx > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Zx << " " << itt->uom << "\r\n"; itt++;
    if (Sx > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Sx << " " << itt->uom << "\r\n"; itt++;
    if (rx > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << rx << " " << itt->uom << "\r\n"; itt++;
    if (Iy > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Iy << " " << itt->uom << "\r\n"; itt++;
    if (Zy > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Zy << " " << itt->uom << "\r\n"; itt++;
    if (Sy > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Sy << " " << itt->uom << "\r\n"; itt++;
    if (ry > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << ry << " " << itt->uom << "\r\n"; itt++;
    if (Iz > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Iz << " " << itt->uom << "\r\n"; itt++;
    if (rz > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << rz << " " << itt->uom << "\r\n"; itt++;
    if (Sz > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Sz << " " << itt->uom << "\r\n"; itt++;
    if (J > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << J << " " << itt->uom << "\r\n"; itt++;
    if (Cw > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Cw << " " << itt->uom << "\r\n"; itt++;
    if (C > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << C << " " << itt->uom << "\r\n"; itt++;
    if (Wno > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Wno << " " << itt->uom << "\r\n"; itt++;
    if (Sw1 > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Sw1 << " " << itt->uom << "\r\n"; itt++;
    if (Sw2 > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Sw2 << " " << itt->uom << "\r\n"; itt++;
    if (Sw3 > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Sw3 << " " << itt->uom << "\r\n"; itt++;
    if (Qf > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Qf << " " << itt->uom << "\r\n"; itt++;
    if (Qw > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Qw << " " << itt->uom << "\r\n"; itt++;
    if (ro > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << ro << " " << itt->uom << "\r\n"; itt++;
    if (H1 > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << H1 << " " << itt->uom << "\r\n"; itt++;
    if (tan_alpha > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << tan_alpha << " " << itt->uom << "\r\n"; itt++;
    if (Iw > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << Iw << " " << itt->uom << "\r\n"; itt++;
    if (zA > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << zA << " " << itt->uom << "\r\n"; itt++;
    if (zB > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << zB << " " << itt->uom << "\r\n"; itt++;
    if (zC > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << zC << " " << itt->uom << "\r\n"; itt++;
    if (wA > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << wA << " " << itt->uom << "\r\n"; itt++;
    if (wB > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << wB << " " << itt->uom << "\r\n"; itt++;
    if (wC > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << wC << " " << itt->uom << "\r\n"; itt++;
    if (SwA > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << SwA << " " << itt->uom << "\r\n"; itt++;
    if (SwB > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << SwB << " " << itt->uom << "\r\n"; itt++;
    if (SwC > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << SwC << " " << itt->uom << "\r\n"; itt++;
    if (SzA > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << SzA << " " << itt->uom << "\r\n"; itt++;
    if (SzB > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << SzB << " " << itt->uom << "\r\n"; itt++;
    if (SzC > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << SzC << " " << itt->uom << "\r\n"; itt++;
    if (rts > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << rts << " " << itt->uom << "\r\n"; itt++;
    if (ho > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << ho << " " << itt->uom << "\r\n"; itt++;
    if (PA > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << PA << " " << itt->uom << "\r\n"; itt++;
    if (PA2 > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << PA2 << " " << itt->uom << "\r\n"; itt++;
    if (PB > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << PB << " " << itt->uom << "\r\n"; itt++;
    if (PC > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << PC << " " << itt->uom << "\r\n"; itt++;
    if (PD > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << PD << " " << itt->uom << "\r\n"; itt++;
    if (T1 > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << T1 << " " << itt->uom << "\r\n"; itt++;
    if (WGi > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << WGi << " " << itt->uom << "\r\n"; itt++;
    if (WGo > 0) output << std::left << std::setw(58) << std::setfill('.') << itt->field_name << " " << itt->var_name << " = " << WGo << " " << itt->uom << "\r\n";

    std::string outputStr = output.str();  // Get the string from std::ostringstream

    // Check and remove the BOM (0xEF, 0xBB, 0xBF in UTF-8)
    if (outputStr.size() >= 3 &&
        static_cast<unsigned char>(outputStr[0]) == 0xEF &&
        static_cast<unsigned char>(outputStr[1]) == 0xBB &&
        static_cast<unsigned char>(outputStr[2]) == 0xBF) {
        outputStr = outputStr.substr(3);  // Remove the BOM
    }
    return outputStr;
}
